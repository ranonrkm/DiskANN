...
query_path="${root}/query_text_100K.bin"
nnid_path="${root}/results/train_vamana_500_idx_uint32.bin"
R=64
Lbuild=128
alpha=1.2
index_path="${root}/vamana_R${R}_L${Lbuild}_A${alpha}_qb"
...
res_path="${root}/results/train_vamana"
